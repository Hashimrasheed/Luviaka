...
var upqty = document.querySelectorAll('.upqty');
upqty.forEach(function (upqty) {
  upqty.addEventListener('click', function () {
    // console.log('hi');
    var newqty = JSON.parse(upqty.dataset.upqty);
    updateqty(newqty);
  });
});

function updateqty(newqty) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/updateupqty', newqty.item).then(function () {
    location.reload();
  })["catch"](function (err) {
    location.reload();
  });
...
var downqty = document.querySelectorAll('.downqty');
downqty.forEach(function (downqty) {
  downqty.addEventListener('click', function () {
    // console.log('hi');
    var newqty = JSON.parse(downqty.dataset.downqty);
    updatedownqty(newqty);
  });
});

function updatedownqty(newqty) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/updatedownqty', newqty.item).then(function () {
    location.reload();
  })["catch"](function (err) {
    location.reload();
  });
...
function deleteItems(dele) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/deleteCartItem', dele.item).then(function () {
    location.reload();
  })["catch"](function (err) {
    location.reload();
  });
...
deleteItem.forEach(function (dele) {
  dele.addEventListener('click', function () {
    var del = JSON.parse(dele.dataset.dele);
    deleteItems(del);
  });
...
updateStatus(order); //add quick view

var details = document.querySelectorAll('.view');
details.forEach(function (view) {
...
function fullDetails(details) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/popup', details).then(function () {});
} //image zooming
...
function imageZoom(imgID) {
  ...
  lens.style.backgroundImage = "url( ".concat(img.src, " )");
  var ratio = 2;
  ...
  function getCurser() {
    var e = window.event;
    var bounds = img.getBoundingClientRect(); // console.log('e', e);
...
__webpack_require__(/*! /home/hashim/Desktop/weekly_tasks/week 9/luviaka/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/hashim/Desktop/weekly_tasks/week 9/luviaka/resources/scss/app.scss */"./resources/scss/app.scss");
